...
async def get_community_metrics():
    ...
    return {}
    bot_count_metrics_url = f"{constants.BASE_OUR_SERVER}/api/v1/auth/metrics/community/count/"
    bot_top_metrics_url = f"{constants.BASE_OUR_SERVER}/api/v1/auth/metrics/community/top/"
